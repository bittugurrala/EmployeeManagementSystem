export default function CreateTaks(){
    return(
        <div className="h-screen w-screen flex flex-col">
                    <div className="w-screen flex items-start px-10">
                        <form className="w-full flex gap-5">
                            ...
                            <div className="w-1/2">
                                <div className = "flex flex-col  gap-1 mb-5">
                                    ...
                                    <textarea className="border-white border h-[285px] text-gray-300 rounded-2xl px-2 py-3 " placeholder="Description of the Task"></textarea>
                                </div>
